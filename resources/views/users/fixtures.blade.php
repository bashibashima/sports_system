                ...
                <ul>
                    <li>
                        ...
                        <ul class="tg-dropdown-menu">
                            <li><a href="index-2.blade.php">home1</a></li>
                            <li><a href="index2.blade.php">home2</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">team</a>
            ...
            <div class="tg-colhalf">
                <ul>
                    <li class="active">
                        <a href="#">fixtures</a>
                        <ul class="tg-dropdown-menu">
                            <li class="active"><a href="fixtures.blade.php">fixtures</a></li>
									...
									<div class="tg-colhalf pull-right">
										<nav class="tg-addnav">
											<ul>
												...
												<li><a href="javascript().blade.php" data-toggle="modal" data-target="#tg-register">Register</a></li>
												<li>
													<div class="tg-cart">
						...
						<nav id="tg-nav" class="tg-nav brand-center">
							<div class="navbar-header">
								...
								<strong class="tg-logo">
									<a href="index-2.blade.php"><img src="images/logo.png" alt="image description"></a>
								</strong>
							</div>
								...
								<div class="tg-footercol">
									...
									<ul class="tg-contactinfo">
										...
										<li>
											...
											<a href="info%40domain.blade.php">info@domain.com</a>
										</li>
										<li>
